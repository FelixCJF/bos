...
public class User implements java.io.Serializable {
	...
	private Set<Role> roles = new HashSet(0);//当前用户对应的多个角色
	...
	public User(String id, String username, String password, Double salary,
			Timestamp birthday, String gender, String station,
			String telephone, String remark, Set noticebills, Set roles) {
		this.id = id;
