...
<script type="text/javascript">
	...
	function doAssociations(){
		...
		if(rows.length != 1){
			...
			//发送ajax请求，请求Action，
			//在Action中调用代理对象获取客户数据，返回json，将返回的json数据动态填充到下拉框中
			//加载左侧下拉框中的客户信息
			var url1 = "${pageContext.request.contextPath}/decidedzoneAction_findCustomerNotAssociation.action";
			...
			//加载右侧下拉框中的客户信息
			var url2 = "${pageContext.request.contextPath}/decidedzoneAction_findCustomerAssociation.action";
			var did = rows[0].id;//当前选中的定区id
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="定区添加修改" id="addDecidedzoneWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="addForm" action="${pageContext.request.contextPath }/decidedzoneAction_add.action"
					 method="post">
							...
							<script>
								$(function(){
									...
									$("#associationBtn").click(function(){
										//在提交表单之前，将右侧下拉框中的所有option选中
										$("#associationSelect option").attr("selected","selected");
										//在提交表单之前，将当前选中的定区的id赋给隐藏域
